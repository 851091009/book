...
__slots__ 我们已经知道怎么了用了，__len__() 方法我们也知道为了能让 class 作用于 len() 函数。
...
这是因为直接显示变量调用的不是 \__str__()，而是\_\_repr\_\_() ，两者的区别是 \_\_str\_\_ 返回用户看到的字符串，而 \_\_repr\_\_ 返回程序开发者看到的字符串，也就是说，\_\_repr()\_\_ 是为调试服务的。
